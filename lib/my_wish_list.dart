...
class my_wish_list extends StatelessWidget {
  my_wish_list({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Pinned.fromPins(
            Pin(start: -7.0, end: 22.0),
            Pin(size: 638.0, end: 12.0),
            child:
...
const String _svg_5d90dn =
    '<svg viewBox="0.0 812.0 375.0 1.0" ><path transform="translate(0.0, 737.0)" d="M 375 75 L 0 75 L 375 75 Z" fill="#b4eb46" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
