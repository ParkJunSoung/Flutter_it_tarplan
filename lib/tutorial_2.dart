      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'vidar-nordli-mathis…' (shape)
                Container(
