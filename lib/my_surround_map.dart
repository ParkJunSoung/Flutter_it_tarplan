...
class my_surround_map extends StatelessWidget {
  my_surround_map({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 20.0, end: 20.0),
            Pin(size: 332.0, middle: 0.3417),
            child:
                // Adobe XD layer: 'KakaoTalk_Photo_202…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 200.0, start: 19.0),
            Pin(size: 184.0, end: 93.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 31.0, middle: 0.3964),
                  Pin(size: 15.0, start: 7.0),
                  child: Text(
                    '라이딩',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  Pin(size: 55.0, middle: 0.4621),
                  Pin(size: 17.0, middle: 0.1677),
                  child: Text(
                    '라이딩 협회',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 50.0, start: 0.0),
                  child:
                      // Adobe XD layer: '액티비티1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                ...
                Pinned.fromPins(
                  Pin(size: 65.0, middle: 0.5037),
                  Pin(size: 17.0, middle: 0.4311),
                  child: Text(
                    'Early Birds',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 17.0, middle: 0.5689),
                  child: Text(
                    'Stars are a little bright',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 12,
                      color: const Color(0xff777777),
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: '액티비티2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                ...
                Pinned.fromPins(
                  Pin(size: 21.0, middle: 0.3799),
                  Pin(size: 15.0, middle: 0.8343),
                  child: Text(
                    '서핑',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: '액티비티3' (shape)
                      Container(
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
          ...
          Pinned.fromPins(
            Pin(size: 61.0, middle: 0.6911),
            Pin(size: 27.0, middle: 0.6318),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
