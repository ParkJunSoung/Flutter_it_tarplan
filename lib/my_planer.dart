...
import './plam_items.dart';
import 'package:adobe_xd/page_link.dart';
import './food_item.dart';
import './destination_na.dart';
...
class my_planer extends StatelessWidget {
  my_planer({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(start: -549.1, end: -338.1),
            Pin(size: 682.0, start: -386.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 102.0, middle: 0.4689),
            Pin(size: 32.0, middle: 0.291),
            child: Text(
              '속초 여행',
              style: TextStyle(
                ...
                letterSpacing: 0.20250001287460326,
          ...
          Pinned.fromPins(
            Pin(size: 165.0, middle: 0.4429),
            Pin(size: 19.0, middle: 0.3329),
            child: Text(
              '여행 일자 21.05.07 ~ 09',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(size: 93.0, middle: 0.2908),
            Pin(size: 31.0, middle: 0.3854),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20.0),
                color: const Color(0xff2cc41f),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 93.0, middle: 0.7092),
            Pin(size: 31.0, middle: 0.3841),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20.0),
                color: const Color(0xff2cc41f),
          ...
          Pinned.fromPins(
            Pin(size: 49.0, middle: 0.319),
            Pin(size: 17.0, middle: 0.388),
          ...
          Pinned.fromPins(
            Pin(size: 295.0, start: 19.0),
            Pin(size: 1.0, middle: 0.4624),
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 99.0, middle: 0.3696),
            Pin(size: 21.0, middle: 0.5664),
            child: Text(
              '복이네 대박집',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff050505),
                letterSpacing: 0.13500000858306885,
          ...
          Pinned.fromPins(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize: 22,
                color: const Color(0xff050505),
                letterSpacing: 0.1650000104904175,
          ...
          Pinned.fromPins(
            Pin(size: 43.0, start: 45.0),
            Pin(size: 17.0, middle: 0.5208),
            child: Text(
              '13:00',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 17,
                color: const Color(0xff050505),
                letterSpacing: 0.1275000081062317,
          ...
          Pinned.fromPins(
            Pin(size: 58.0, middle: 0.2524),
            Pin(size: 54.0, end: 64.0),
            child:
                // Adobe XD layer: 'mike-fox-467499-uns…' (shape)
                Container(
              decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                ...
                border: Border.all(width: 2.0, color: const Color(0xff9cef7d)),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 56.6, start: 18.0),
            Pin(size: 56.8, end: 61.2),
            child:
                // Adobe XD layer: 'elizeu-dias-520676-…' (shape)
                SvgPicture.string(
              _svg_iqlshk,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
...
const String _svg_r555fg =
    '<svg viewBox="-549.1 -386.0 1262.1 682.0" ><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 500.95, -107.64)" d="M 285.3129272460938 278.3598022460938 C 285.3129272460938 205.4233703613281 -376.8403930664062 212.2149963378906 -173.2093505859375 -117.7426147460938 C 30.42166137695312 -447.702392578125 519.6487426757812 -509.2795715332031 622.75537109375 -211.6817321777344 C 725.8598022460938 85.9139404296875 1050.009643554688 -8.10614013671875 1050.009643554688 -162.6174621582031 L 1050.009643554688 278.3598022460938 L 285.3129272460938 278.3598022460938 Z" fill="#b4eb46" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
const String _svg_730c02 =
    '<svg viewBox="19.0 375.0 295.0 1.0" ><path transform="translate(19.0, 375.0)" d="M 0 0 L 295 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_wne9xa =
    '<svg viewBox="19.0 546.0 295.0 1.0" ><path transform="translate(19.0, 546.0)" d="M 0 0 L 295 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_iqlshk =
    '<svg viewBox="18.0 694.0 56.6 56.8" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="5472.0" height="3648.0"><image xlink:href="null" x="0" y="0" width="5472.0" height="3648.0" /></pattern></defs><path transform="translate(18.0, 694.0)" d="M 28.3001708984375 0 C 43.92992401123047 0 56.600341796875 12.70761013031006 56.600341796875 28.38323974609375 C 56.600341796875 44.05886840820312 43.92992401123047 56.7664794921875 28.3001708984375 56.7664794921875 C 12.67041873931885 56.7664794921875 0 44.05886840820312 0 28.38323974609375 C 0 12.70761013031006 12.67041873931885 0 28.3001708984375 0 Z" fill="url(#image)" stroke="#898888" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
