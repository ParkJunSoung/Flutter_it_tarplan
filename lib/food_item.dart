    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 112.0, start: 19.0),
                  Pin(size: 27.0, end: 3.0),
                  child: Text(
                    '수원역 음식점',
                    style: TextStyle(
                      fontFamily: 'Roboto',
          ...
          Pinned.fromPins(
            Pin(start: 0.0, end: 0.0),
            Pin(size: 578.0, end: 95.0),
            child:
                // Adobe XD layer: '스크린샷 2021-06-…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 10.0, middle: 0.5014),
            Pin(size: 15.0, start: 300.0),
            child:
                // Adobe XD layer: '✏️ Caption' (text)
                Text(
              '홈',
