...
class plam_items extends StatelessWidget {
  plam_items({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 34.0, middle: 0.2493),
            Pin(size: 16.0, middle: 0.3656),
            child: Text(
              '여행지',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 45.0, middle: 0.7545),
            Pin(size: 16.0, middle: 0.3631),
            child: Text(
              '체험코스',
              style: TextStyle(
                fontFamily: 'Poppins',
