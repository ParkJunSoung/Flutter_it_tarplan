...
class my_plan_list extends StatelessWidget {
  my_plan_list({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 175.0, start: 13.0),
            Pin(size: 240.0, middle: 0.3147),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 82.0, start: 19.0),
            Pin(size: 36.0, middle: 0.4794),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 30.0, middle: 0.6058),
            Pin(size: 38.0, middle: 0.8307),
            child:
                // Adobe XD layer: 'mike-fox-467499-uns…' (shape)
                Container(
              decoration: BoxDecoration(
